...
class Projects extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('project_name, project_address, project_area, price_per_sqft, developed_by, type_of_project, type_of_property, image_path, project_description', 'required'),
			array('price_per_sqft', 'numerical', 'integerOnly'=>true),
			array('project_name, project_area', 'length', 'max'=>30),
			array('project_address', 'length', 'max'=>100),
			array('developed_by, type_of_project', 'length', 'max'=>15),
			array('type_of_property', 'length', 'max'=>50),
			array('image_path', 'length', 'max'=>300),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('project_id, project_name, project_address, project_area, price_per_sqft, developed_by, type_of_project, type_of_property, image_path, project_description', 'safe', 'on'=>'search'),
		);
	}
